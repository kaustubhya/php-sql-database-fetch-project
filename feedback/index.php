...
?>
    <img src="/php-sql-database-fetch-project/feedback/logo.png" class="w-25 mb-3" alt="">
    <h2>Feedback</h2>
    <p class="lead text-center">Leave feedback for Traversy Media</p>
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SERVER']);?>" method="POST" class="mt-4 w-75">
      <div class="mb-3">
